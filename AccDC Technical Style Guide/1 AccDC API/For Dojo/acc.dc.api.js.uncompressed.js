...
@end @*/
  ...
  pL.extend({
    ...
    dojoMod: function(o) {
      for (var n in o) {
        if (pL.dojoModVals[n]) {
          if (n == "dataType" && o[n] == "html") o[pL.dojoModVals[n]] = "text";
          else if (n == "cache" || n == "async")
            o[pL.dojoModVals[n]] = o[n] ? false : true;
          else o[pL.dojoModVals[n]] = o[n];
        }
      }
      return o;
    },
            ...
            .then(
              function(data) {
                ...
                pL.handleSuccess(
                  s,
                  xhr,
                  xhr && xhr.response && xhr.response.status
                    ? xhr.response.status
                    : null,
                  data
                );
  ...
  (function(pL) {
    ...
    pL.extend($A, {
      ...
      destroy: function(id, p) {
        ...
        if (r.loaded) dojoConst.destroy(a);
      ...
      var wheel = [],
        ...
        parseRemaining = function(dc) {
          ...
          if (dc.fn.morph && dc.fn.morphObj) {
            ...
            if (dc.append) dojoConst.place(dc.accDCObj, node, "last");
            else if (dc.prepend) dojoConst.place(dc.accDCObj, node, "first");
            else dojoConst.place(dc.accDCObj, node, "only");
