  ...
  (function() {
    ...
    var Expr = (Sizzle.selectors = {
      ...
      filters: {
        ...
        reset: function(elem) {
          return (
            elem.nodeName.toLowerCase() === "input" && "reset" === elem.type
          );
        },
            ...
            return m
              ? m.id === match[1] ||
                (typeof m.getAttributeNode !== "undefined" &&
                  m.getAttributeNode("id").value === match[1])
                ? [m]
                : undefined
              : [];
          }
  ...
  pL.extend({
    filter: function(expr, elems, not) {
      ...
      return elems.length === 1
        ? pL.find.matchesSelector(elems[0], expr)
          ? [elems[0]]
          : []
          ...
          if (
            ...
            if (ret[i].nodeType === 1) {
              ret.splice.apply(
                ret,
                [i + 1, 0].concat(
                  pL.makeArray(ret[i].getElementsByTagName("script"))
                )
              );
            }
...
*/
    ...
    ajax: function(origSettings) {
      var s = pL.extend(true, {}, pL.ajaxSettings, origSettings),
        jsonp,
        status,
        data,
      ...
      var parts = rurl.exec(s.url),
        remote =
          parts &&
          ((parts[1] && parts[1].toLowerCase() !== location.protocol) ||
      ...
      pL.each(obj, function(i, v) {
        if (traditional || rbracket.test(prefix)) {
          ...
          buildParams(
            prefix +
              "[" +
              (typeof v === "object" || pL.isArray(v) ? i : "") +
              "]",
            v,
            traditional,
            add
  ...
  pL.extend({
    ...
    triggerGlobal: function(s, type, args) {
      (s.context && s.context.url == null ? pL(s.context) : pL.event).trigger(
        type,
        args
      );
    },
