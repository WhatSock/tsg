...
(function() {
  $A.setTabs = function(selector, overrides, useARIA, context, callback) {
    var tabIds = [],
      ...
      tabs = $A.query(selector, context, function(i, o) {
        ...
        var id = o.id || $A.genId(),
          ovrs = {},
          isInternal = $A.getAttr(o, "data-internal");
        ovrs.id = id;
        ...
        ovrs.trigger = o;
        ovrs.mode =
          typeof overrides.mode === "number"
            ? overrides.mode
            : overrides.preload
            ? 0
            : 1;
        ovrs.source = isInternal
          ? (function() {
              var g = $A.getEl(isInternal);

              if (g) return g.parentNode.removeChild(g);
              else return $A.reg[o.id] && $A.reg[o.id].source;
            })()
          : (function() {
              var d = $A.createEl("div"),
                s = $A.getAttr(o, "data-src");
              s = s.replace("#", " #");
                  ...
                  if (overrides.preloadImages) {
                    ...
                    $A.query("img", d, function(i, o) {
                      if (
                        ...
                        overrides.imgLoader.appendChild(
                          $A.createEl("img", {
                            src: o.src,
                            alt: ""
                          })
        ...
        ovrs.bind = "click";
        ovrs.ariaLevel =
          $A.getAttr(o, "data-headinglvl") || overrides.ariaLevel || 3;
    ...
    } else checkTabs(selector, context);
    $A(wheel, overrides);
    return tabIds;
  };
  ...
  var createARIATabs = function(selector, context, start) {
          ...
          $A.bind(this, {
            ...
            keydown: function(ev) {
              ...
              if (k >= 35 && k <= 40 && !ev.altKey) {
                ...
                else if (k == 35) index = tabs.length - 1;
                else if (k == 36) index = 0;
    ...
    setClosest = function(start, owns) {
      var i = 0;
