	...
	var treeId = $A.setTree(
					...
					overrides:
									...
									runAfter: function(dc){
										...
										$A.setMenu('a.leaf', 'hiddenDivId', 'context-menu', function(ev, dc){
...
// Event bindings are also tied to this tag
														...
														overrides:
																		...
																		runDuring: function(dc){
																			...
																			if (dc.top == dc){
																				dc.top.css(
																								{
																								top: $A.xOffset(dc.top.triggerObj).top + (dc.top.triggerObj.offsetHeight / 2),
																								left: $A.xOffset(dc.top.triggerObj).left + (dc.top.triggerObj.offsetWidth * 0.7)
																								});
																			}
										...
										if ('ontouchstart' in window){
											...
											$A.query('a.leaf', dc.containerDiv, function(i, tgr){
												var mI = createMenuIcon('Open Menu', tgr, tgr.id), position = function(){
													$A.css(mI,
																	{
