...
// alert(dc.containerDiv.innerHTML);
	...
	$A.setMenu('a.accTab', 'hiddenDivId', 'context-menu', function(ev, dc){
					...
					overrides:
									...
									runDuring: function(dc){
										if (dc.top == dc){
											...
											dc.top.css(
															{
															top: $A.xOffset(dc.top.triggerObj).top + dc.top.triggerObj.offsetHeight + 10,
															left: $A.xOffset(dc.top.triggerObj).left + (dc.top.triggerObj.offsetWidth * 0.3)
															});
										}
