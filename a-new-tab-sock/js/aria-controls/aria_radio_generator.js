...
// Set defaultRadioVal to -1 to prevent a default selection from being made automatically
	$A.RadioGroup = function(radioGroupObj, selector, defaultRadioVal, legendText, callback){
		...
		that.set = function(index){
			if (( typeof index === 'string' && !index) || ( typeof index === 'number' && index < 0)
				|| ( typeof index === 'object'))
				return;
